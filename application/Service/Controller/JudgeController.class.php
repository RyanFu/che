...
class JudgeController extends AdminbaseController {
    /**
     * 服务列表
     */
    public function judgelist()
    {
        ...
        $list=M("service")->where($condition)->judge("id desc")->limit($page->firstRow , $page->listRows)->select();
